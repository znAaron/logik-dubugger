...
let sessionId = "3b91633e-5392-428e-87ca-e42d3b27a8c8"
...
const validationContent = fs.readFileSync('./' + blueprintName + '/VALIDATION.js', 'utf-8');
const sessionRunnerPath = './Sessions/';
const combinedFilePath = path.join(sessionRunnerPath, sessionId + '/validation_runner.js');
...
packageJson.scripts.validate = `node ${combinedFilePath}`;
